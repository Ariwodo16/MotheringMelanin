...
const faqs = [
  ...
  { question: "Where do you serve?", answer: "I primarily serve Hillsborough, Pinellas, Pasco, and Polk counties in the Tampa Bay area. Reach out if you're unsure whether I cover your location." },
